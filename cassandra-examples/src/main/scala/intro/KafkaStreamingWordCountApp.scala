 ...
 * 5. Creates a Spark Streaming Kafka input stream which pulls messages from a Kafka Broker,
 *    runs basic Spark computations on the streaming data, and writes results to Cassandra
