...
object SparkOnHBase {
  ...
  def main(args: Array[String]) {
    ...
    conf.set("hbase.zookeeper.quorum", "10.57.17.126,10.57.17.125,10.57.17.80")
    ...
    def convert(triple: (Int, String, Int)) = {
      ...
      p.addColumn(Bytes.toBytes("basic"),Bytes.toBytes("name"),Bytes.toBytes(triple._2)) // column: name
      p.addColumn(Bytes.toBytes("basic"),Bytes.toBytes("age"),Bytes.toBytes(triple._3)) // column: age
